...
<body>
	...
	<section class="container-fluid col-lg-8 mt-4">
		...
		<c:if test="${sessionScope.member.userName == requestScope.boardDTO.writer }">
			<div class="row">
				<a class="btn btn-success" href="./update.iu?num=${requestScope.boardDTO.num }" role="button">공지사항 수정</a>
				<a class="btn btn-danger" href="./delete.iu?num=${requestScope.boardDTO.num }" role="button">공지사항 삭제</a>
			</div>
		</c:if>
	</section>
